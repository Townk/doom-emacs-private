...
(use-package! mixed-pitch
  :defer t
  :init
  (add-hook! (wordnut-mode Info-mode lexic-mode)
...
(after! info
  (custom-theme-set-faces! 'doom-tomorrow-night
    '(info-title-1 :foreground "#81a2be" :height 1.8 :weight normal :slant normal :inherit variable-pitch)
    '(info-title-2 :foreground "#c9b4cf" :height 1.7 :weight normal :slant italic :inherit variable-pitch)
    '(info-title-3 :foreground "#b294bb" :height 1.6 :weight normal :slant italic :inherit variable-pitch)
    '(info-title-4 :foreground "#a0b9ce" :height 1.5 :weight bold   :slant normal :inherit variable-pitch)
    '(info-menu-header :foreground "#c9b4cf" :height 1.3 :weight bold   :slant normal :inherit variable-pitch)
    ...
    '(info-glossary-word :foreground "#f0c674"
                         :background "#362C18"
                         :box (:line-width -1 :color "#f0c674" :style released-button)
                         :inherit fixed-pitch)
    '(link-visited :foreground "#b294bb")
    '(info-double-quoted-name :inherit font-lock-string-face)
    '(info-string :inherit font-lock-string-face)
    '(info-header-node :height 160 :inherit info-node)
    '(info-header-xref :height 160 :inherit info-xref))
...
#+caption: autoload/capture.el
#+begin_src emacs-lisp :tangle autoload/capture.el :mkdirp yes
(defconst +org-capture-supported-icons
  '(calendar
    checklist
    contact-add
    globe
...
#+caption: autoload/capture.el
#+begin_src emacs-lisp :tangle autoload/capture.el :mkdirp yes
(defun +org-capture-get-string-icon (icon color)
...
"
  (pcase icon
    ('calendar
     (propertize "--"
                 'face `(:family ,(all-the-icons-material-family) :foreground ,color)
                 'display (all-the-icons-octicon "calendar" :height 1.05 :v-adjust 0.1)))
    ('checklist
     (propertize "--"
                 'face `(:family ,(all-the-icons-octicon-family) :foreground ,color)
                 'display (all-the-icons-octicon "checklist" :height 0.95 :v-adjust 0.1)))
    ('contact-add
     (propertize "--"
                 'face `(:family ,(all-the-icons-material-family) :foreground ,color)
                 'display (all-the-icons-material "person_add" :height 0.95 :v-adjust -0.17)))
    ('globe
     (propertize "--"
                 'face `(:family ,(all-the-icons-faicon-family) :foreground ,color)
                 'display (all-the-icons-faicon "globe" :height 1.15 :v-adjust -0.05)))
    ('help
     (propertize "--"
                 'face `(:family ,(all-the-icons-material-family) :foreground ,color)
                 'display (all-the-icons-material "live_help" :height 0.95 :v-adjust -0.22)))
    ('history
     (propertize "--"
                 'face `(:family ,(all-the-icons-material-family) :foreground ,color)
                 'display (all-the-icons-material "history" :height 0.95 :v-adjust -0.17)))
    ('idea
     (propertize "--"
                 'face `(:family ,(all-the-icons-material-family) :foreground ,color)
                 'display (all-the-icons-material "lightbulb_outline" :height 0.95 :v-adjust -0.17)))
    ('inbox
     (propertize "--"
                 'face `(:family ,(all-the-icons-material-family) :foreground ,color)
                 'display (all-the-icons-material "inbox" :height 0.95 :v-adjust -0.15)))
    ('journal
     (propertize "--"
                 'face `(:family ,(all-the-icons-material-family) :foreground ,color)
                 'display (all-the-icons-material "book" :height 0.95 :v-adjust -0.15)))
    ('list
     (propertize "--"
                 'face `(:family ,(all-the-icons-faicon-family) :foreground ,color)
                 'display (all-the-icons-faicon "list" :height 0.93 :v-adjust -0.05)))
    ('meeting
     (propertize "--"
                 'face `(:family ,(all-the-icons-material-family) :foreground ,color)
                 'display (all-the-icons-material "date_range" :height 0.95 :v-adjust -0.15)))
    ('notes
     (propertize "--"
                 'face `(:family ,(all-the-icons-material-family) :foreground ,color)
                 'display (all-the-icons-material "library_books" :height 0.95 :v-adjust -0.1)))
    ('postit
     (propertize "--"
                 'face `(:family ,(all-the-icons-faicon-family) :foreground ,color)
                 'display (all-the-icons-faicon "sticky-note" :height 1.15 :v-adjust 0.05)))
    ('project
     (propertize "--"
                 'face `(:family ,(all-the-icons-octicon-family) :foreground ,color)
                 'display (all-the-icons-octicon "briefcase" :height 1.05 :v-adjust 0.05)))
    ('review
     (propertize "--"
                 'face `(:family ,(all-the-icons-material-family) :foreground ,color)
                 'display (all-the-icons-material "rate_review" :height 0.95 :v-adjust -0.15)))
    ('stop
     (propertize "--"
                 'face `(:family ,(all-the-icons-octicon-family) :foreground ,color)
                 'display (all-the-icons-octicon "stop" :height 1.05 :v-adjust -0.05)))
    ('timer
     (propertize "--"
                 'face `(:family ,(all-the-icons-material-family) :foreground ,color)
                 'display (all-the-icons-material "timer" :height 0.95 :v-adjust -0.15)))))
#+end_src
    ...
    (if icon
        (progn
          (unless (and (consp icon)
                       (memq (car-safe icon) +org-capture-supported-icons)
                       (stringp (cdr-safe icon)))
            (error (concat "A capture description icon must be a cons cell with"
                           " one of +org-capture-supported-icons symbol and a string color.")))
          (format "%s %s" (+org-capture-get-string-icon (car icon) (cdr icon)) text))
      text)))
#+end_src
...
#+begin_src emacs-lisp
  (pushnew! org-capture-templates
            `("n"  ,(+org-capture-description :text "Fleet note" :icon '(notes . "#b5bd68"))
...
#+begin_src emacs-lisp
  (pushnew! org-capture-templates
            `("j"  ,(+org-capture-description :text "Journal" :icon '(journal . "#81a2be")))
            `("js" ,(+org-capture-description :text "Support" :icon '(help . "#de935f"))
...
#+begin_src emacs-lisp
  (pushnew! org-capture-templates
            `("t"  ,(+org-capture-description :text "Tasks" :icon '(inbox . "#de935f")))
            `("tt" ,(+org-capture-description :text "General task" :icon '(inbox . "#b5bd68"))
              plain (function +org-capture-journal-file)
              ,(concat "** TODO %?\n"
                       "%(+org-capture-template-selection)")
              :kill-buffer t)
            `("td" ,(+org-capture-description :text "Task with deadline" :icon '(timer . "#f0c674"))
              plain (function +org-capture-journal-file-for-task-with-deadline)
              ,(concat "** TODO %?\n"
                       "DEADLINE: %(+org-capture-last-time-read)\n"
                       "%(+org-capture-template-selection)")
              :kill-buffer t)
            `("ts" ,(+org-capture-description :text "Scheduled task" :icon '(calendar . "#de935f"))
...
#+begin_src emacs-lisp
  (pushnew! org-capture-templates
            `("c" ,(+org-capture-description :text "Contact" :icon '(contact-add . "#f0c674"))
...
#+begin_src emacs-lisp
  (pushnew! org-capture-templates
            `("p"  ,(+org-capture-description :text "Projct" :icon '(project . "#b294bb")))
            `("pt" ,(+org-capture-description :text "New task" :icon '(checklist . "#b5bd68"))
              entry (file+headline +org-capture-project-notes-file-wrapper "Tasks")
              ,(concat "* TODO %?\n"
                       "%(+org-capture-template-selection)")
              :kill-buffer t)
            `("pn" ,(+org-capture-description :text "Quick note" :icon '(postit . "#f0c674"))
              entry (file+headline +org-capture-project-notes-file-wrapper "Notes")
              ,(concat "* %U %?\n"
                       "%(+org-capture-template-selection)")
              :kill-buffer t)
            `("pc" ,(+org-capture-description :text "New changelog" :icon '(list . "#b294bb"))
  ...
  (let ((org-capture-templates
    ...
    (if keys
      ...
      (org-mks org-capture-templates
               ...
               " "
               `(("q" ,(+org-capture-description :text "Abort" :icon '(stop . "#d54e53"))))))))
