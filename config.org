...
What I recommend to do, is to install a package called [[https://github.com/dholm/benchmark-init-el][~benchmark-init-el~]] that specializes on benchmarking, and use it, when you have the need:
