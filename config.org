...
#+caption: $DOOMDIR/config.el
#+begin_src emacs-lisp :noweb-ref none :tangle (if (file-exists-p "/usr/local/var/homebrew/linked/plantuml/libexec/plantuml.jar") "no" "config.el")
(setq plantuml-jar-path "/tmp/plantuml.jar"
      org-plantuml-jar-path plantuml-jar-path)
#+end_src
