...
Unfortunately, Evil hard-code the [[https://github.com/magnars/.emacs.d/blob/master/site-lisp/evil/evil-visual.el#L372][visual]] [[https://github.com/magnars/.emacs.d/blob/master/site-lisp/evil/evil-visual.el#L474][priority]] value to 99 for visual selection, which is smaller then the value for the search highlight overlays.
...
I saw that a potential fix for ~solaire~ and ~variable-pitch~ mode is on the works, and I couldn't hold myself to try it out.

To do so, I first need to unpin ~solaire~:
...
And then, add [[https://gist.github.com/hlissner/5ac38df98c366f7ffc95c3564ffc73cf][this gist]] to my config:
