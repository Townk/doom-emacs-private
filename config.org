...
| Headline Level | Proportional size | Multiplier rate |
|----------------+-------------------+-----------------|
| Level 1        |              100% |             2.0 |
| Level 2        |               80% |             1.8 |
| Level 3        |               60% |             1.6 |
...
#+begin_src emacs-lisp
(set-popup-rule! "^\\*info\\*$"
  :slot 2   :vslot -1     :side 'right  :width 90 :height 0.4
  :select t :modeline nil :autosave nil :ttl 0    :quit t)
#+end_src
...
#+caption: config.el
#+begin_src emacs-lisp
(add-hook! (help-mode helpful-mode) #'my-help-buffer-config-h)
#+end_src
