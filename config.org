...
;;;###autoload
(defadvice! my-center-after-jump (&rest _)
...
#+begin_src emacs-lisp
(after! evil
  (add-hook 'evil-jumps-post-jump-hook #'my-center-after-jump))
#+end_src
...
You are awesome! I can't imagine how liberating it would feel if my brain did not obsessed about my editor's appearance, so, stay strong guys! The breakthroughs on technology happens more often by the desired of people like you then people like me.
...
Since the time when widescreen monitors became the standard, when it comes to split windows in two, I prefer horizontal splits (one window aside of the other). In order to tell Emacs that I prefer horizontal splits, I have to set the width split threshold to a small number to add weight on Emacs' decision of which orientation to slipt:
...
*** Theme ✅
I believe this section to be the most volatile section on this text. Since I got interested on cool old exoteric editors, I'm on an endless search for the Holy Graal of themes. So far I got fond of Tomorrow Night and I use it for the most part of the last 5 years. Recently I got annoyed by some color choices of the theme (the background and line highlight are a bit odd in my opinion), so I kept looking.
...
- [[https://github.com/iaolo/iA-Fonts][iA Writer Mono]] :: Used as my default font. I particularly like the italic face for this font.
- [[https://github.com/iaolo/iA-Fonts][iA Writer Quattro]] :: Used as my default font. I particularly like the italic face for this font.
...
#+caption: config.el
#+begin_src emacs-lisp
(defface my-default-mono `((t :font ,(font-spec :family "RobotoMono Nerd Font"
                                                :size 15)))
  "Default monospaced font used on majority of the buffers."
  :group 'my-typography)

(defface my-big-face-mono `((t :font ,(font-spec :family "RobotoMono Nerd Font"
                                                 :size 26)))
...
I just need to set the main 3 fonts of Doom, to the ones I selected (we will use the =my-default-ui= when we need it down the road):
...
(after! info
  (custom-set-faces!
    `(info-title-1 :inherit my-headline-1
                   ;; :foreground ,(face-attribute 'outline-1 :foreground)
                   :weight unspecified
                   :slant unspecified)
    `(info-title-2 :inherit my-headline-2
                   ;; :foreground ,(face-attribute 'outline-2 :foreground)
                   :weight unspecified
                   :slant unspecified)
    `(info-title-3 :inherit my-headline-3
                   ;; :foreground ,(face-attribute 'outline-3 :foreground)
                   :weight unspecified
                   :slant unspecified)
    `(info-title-4 :inherit my-headline-4
                   ;; :foreground ,(face-attribute 'outline-4 :foreground)
                   :weight unspecified
                   :slant unspecified)
    `(info-menu-header :inherit my-headline-5
                       ;; :foreground ,(face-attribute 'info-menu-header :foreground)
                       :weight unspecified
                       :slant unspecified)
...
I want to also creat a thin-wrapper around the ~plist-get~ to retrieve the icon string for a given symbol:
...
(use-package! tab-line
  ...
  (defcustom tab-line-tab-max-width 60
...
(defun my-tabs-mode-persp-window ()
  "Return a list of buffers that should have a tab for them.

This functio treat 2 kinds of buffers differentely than the others. The first
are org-capture buffers, which should never have a tab associated with them. And
the second, dired buffers. Dired buffers should always have just the last buffer
displayed on the tab line."
...
(defun my-tabs-hide-tab-line-maybe-h ()
  "Disable `tab-line-modee' for non-real buffers.
...
(defun +workspace-resolve-session-file-path (&optional name)
  "Returns the full path for a session file name given a NAME identifier.
...
(defvar +workspaces-data-file-prefix "_workspaces_"
  "The file name prefix of files used to store a workspace session. We will store
...
(defun my-adjust-outline-fonts-h ()
  (after! outline
    (custom-set-faces!
     `(outline-1 :inherit my-headline-1
                 ;; :foreground ,(face-attribute 'outline-1 :foreground)
                 :weight unspecified
                 :slant unspecified)
     `(outline-2 :inherit my-headline-2
                 ;; :foreground ,(face-attribute 'outline-2 :foreground)
                 :weight unspecified
                 :slant unspecified)
     `(outline-3 :inherit my-headline-3
                 ;; :foreground ,(face-attribute 'outline-3 :foreground)
                 :weight unspecified
                 :slant unspecified)
     `(outline-4 :inherit my-headline-4
                 ;; :foreground ,(face-attribute 'outline-4 :foreground)
                 :weight unspecified
                 :slant unspecified)
     `(outline-5 :inherit my-headline-5
                 ;; :foreground ,(face-attribute 'outline-5 :foreground)
                 :weight unspecified
                 :slant unspecified)
     `(outline-6 :inherit my-headline-6
                 ;; :foreground ,(face-attribute 'outline-6 :foreground)
                 :weight unspecified
                 :slant unspecified)
     `(outline-7 :inherit my-headline-7
                 ;; :foreground ,(face-attribute 'outline-7 :foreground)
                 :weight unspecified
                 :slant unspecified)
     `(outline-8 :inherit my-headline-8
...
(defun my-adjust-org-fonts-h ()
  (after! org
    (custom-set-faces!
      '(org-document-title :height unspecified :weight unspecified :slant unspecified :inherit my-document-title)
...
(defun my-setup-markdown-faces-h ()
  (custom-set-faces!
    `(markdown-header-face :inherit unspecified)
    `(markdown-header-face-1 :inherit my-headline-1
                             :foreground ,(face-attribute 'outline-1 :foreground)
                             :weight unspecified
                             :slant unspecified)
    `(markdown-header-face-2 :inherit my-headline-2
                             :foreground ,(face-attribute 'outline-2 :foreground)
                             :weight unspecified
                             :slant unspecified)
    `(markdown-header-face-3 :inherit my-headline-3
                             :foreground ,(face-attribute 'outline-3 :foreground)
                             :weight unspecified
                             :slant unspecified)
    `(markdown-header-face-4 :inherit my-headline-4
                             :foreground ,(face-attribute 'outline-4 :foreground)
                             :weight unspecified
                             :slant unspecified)
    `(markdown-header-face-5 :inherit my-headline-5
                             :foreground ,(face-attribute 'outline-5 :foreground)
                             :weight unspecified
                             :slant unspecified)
    `(markdown-header-face-6 :inherit my-headline-6
                             :foreground ,(face-attribute 'outline-6 :foreground)
                             :weight unspecified
                             :slant unspecified)))
...
(after! magit
  ...
  (add-hook 'git-commit-setup-hook 'my-git-commit-mode-setup-h))
#+end_src

#+caption: autoload/development.el
#+begin_src emacs-lisp :tangle autoload/development.el
;;;###autoload
(defun my-git-commit-mode-setup-h ()
...
#+caption: snippets/git-commit-mode/commit-message
